...
function BookCard(props) {
    ...
    return (
        <div className="flex items-center justify-center">
            <a href={"/books/"+1}>
                <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl hover:scale-105 duration-500 transform transition cursor-pointer max-w-213 h-80x2">
